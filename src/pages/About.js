    ...
    <>
        ...
        <div className="mt-3 row">
          <div className="mt-2 mb-1 col-md-5 pt-5 abt-cnt">
            ...
            <p className="font-bold " style={{ fontSize: "15px" }}>
              ...
              interest! that’s how I got into Web Development while studying in
              college. I mainly use React for frontend and NodeJS for backend.
              if you're looking for a developer to add to your team, I'd love to
              hear from you!{" "}
            </p>

            {/* <button className='btn btn-dark mx-auto resume' onClick={() => window.open( 'https://drive.google.com/file/d/14nmCG2yk9Rsb4OEZGkQdpvudfxjg6Ukk/view?usp=sharing' )}>
            Resume  <IoMdOpen size={22} className='icon'/>
            </button> */}
          </div>

          <div
            className="who-is flex-with-center col-md-7"
      ...
      <div className="container devstack n-box-2 py-3 mt-5">
        <div className="text-center">
          <h3
            className="font-bold text-center mt-5 mydev"
            style={{ fontSize: "70px" }}
          >
